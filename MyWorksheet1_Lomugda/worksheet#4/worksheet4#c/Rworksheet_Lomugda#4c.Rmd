...
library(ggplot2)
ggplot(manufacmodel, aes(x=manufacturer,y = unique_models))+
...
4a.
```{r}
#Plot using geom_bar() using the top 20 observations only. The graphs shoudl have a title, labels andcolors. Show code and results.
library(dplyr)
library(ggplot2)
